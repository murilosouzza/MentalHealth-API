            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UsuarioId = table.Column<int>(type: "integer", nullable: false),
                    QualidadeSono = table.Column<int>(type: "integer", nullable: false),
                    Medicacao = table.Column<string>(type: "text", nullable: false),
                    Disposicao = table.Column<int>(type: "integer", nullable: false),
                    Ansiedade = table.Column<string>(type: "text", nullable: false),
